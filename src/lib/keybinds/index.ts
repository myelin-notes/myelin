...
registry.defineDefaults({
  ...
  'editor:bold': { key: 'b', mod: true },
  'editor:italic': { key: 'i', mod: true },
  'editor:underline': { key: 'u', mod: true },
  'editor:strikethrough': { key: 's', mod: true, shift: true },
  'editor:code': { key: 'e', mod: true },
});
