...
import { WheelItem } from "@/components/wheel-picker";
import { loadWheelToolIndices, saveWheelToolIndices } from "@/components/tool-shelf";
...
export function useToolState(drawableCanvasRef: React.RefObject<DrawableCanvas | null>) {
