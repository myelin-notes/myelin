export const explorerGridCardClass =
  'group relative flex w-full min-w-0 cursor-pointer flex-col overflow-hidden rounded-[1.1rem] bg-card/75 text-left ring-1 ring-border-subtle/70 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-card hover:shadow-ambient';
