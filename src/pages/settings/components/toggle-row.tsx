...
export function ToggleRow({
  ...
  return (
    <button
      ...
      onClick={onToggle}
      className="flex w-full cursor-pointer items-center justify-between gap-4 rounded-xl bg-input px-4 py-3 text-left ring-1 ring-border-subtle/70 transition-colors hover:bg-card-active"
    >
