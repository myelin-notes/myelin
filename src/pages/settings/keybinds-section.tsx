...
function KeybindRow({
  ...
  return (
    <div className="group flex w-full items-center gap-3 rounded-xl bg-input/40 px-3 py-2.5 text-left ring-1 ring-border-subtle/70 transition-colors hover:bg-card-active sm:gap-4 sm:px-4">
