...
export const FIELD_TRIGGER_CLASS =
  'group flex h-9 min-w-0 cursor-pointer items-center gap-2 rounded-lg bg-transparent px-2.5 text-left text-sm text-text-primary outline-none transition-colors hover:bg-card-active aria-expanded:bg-card-active disabled:cursor-not-allowed disabled:hover:bg-transparent disabled:opacity-60';
