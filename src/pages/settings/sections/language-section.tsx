...
export function LanguageSection() {
  ...
  return (
    <section id="language" className="scroll-mt-12">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger className="group flex w-full max-w-xs cursor-pointer items-center justify-between rounded-xl bg-input px-4 py-3 text-sm ring-1 ring-border-subtle/70 transition-colors hover:bg-card-active">
